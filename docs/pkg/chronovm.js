...
export class Session {
    ...
    explainVar(i, _var) {
        ...
        const ret = wasm.session_explainVar(this.__wbg_ptr, i, ptr0, len0);
        if (ret[2]) {
     ...
     */
    frame(i) {
        const ret = wasm.session_frame(this.__wbg_ptr, i);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    frameCount() {
        const ret = wasm.session_frameCount(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    program() {
        const ret = wasm.session_program(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('chronovm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
